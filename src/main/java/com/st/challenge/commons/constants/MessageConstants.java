...
public class MessageConstants {
    ...
    public static final String MAX_PRESCRIPTION_RULE_EXCEPTION = "No es posible asignar medicamento ya que se han prescrito 3 medicamentos el último mes, o el medicamento ya fue prescrito al paciente el último mes";
